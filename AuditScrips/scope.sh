...
cat Pentest_${NAME}/targets/resolved_hosts.txt | grep "has address" | sed 's/ has address /\t/g' | sort -u | cut -f2 > Pentest_${NAME}/targets/allipv4addreses.txt
...
cat Pentest_${NAME}/targets/ipaddresses.txt Pentest_${NAME}/targets/allipv4addreses.txt Pentest_${NAME}/targets/hosts2ipv6addreses.txt > Pentest_${NAME}/targets/allipaddreses.txt
cat Pentest_${NAME}/targets/allipaddreses.txt
